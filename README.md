...
画面右上に `v1.3.0 · 2026-08-28 10:29` のように、バージョンと配信ファイルの更新時刻を表示します。リポジトリへのリンクになっています。時刻は `document.lastModified` から取っており、GitHub Pages ではデプロイ時刻になるため、番号の付け替えを忘れてもデプロイが反映されたか判別できます。
